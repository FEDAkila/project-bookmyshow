            ...
            <AppBar position="static" sx={{backgroundColor:"rgb(51, 53, 69)"}}>
                <Container>
                    ...
                    <Typography
                        ...
                        component="div"
                        alignItems={"center"}
                        sx={{ display: { xs: 'block', sm: 'block' },mt:2 }}
                    >
                        <a href="#">
                            <svg viewBox="0 0 88 26" height="38" width="115" xmlns="http://www.w3.org/2000/svg">
                        ...
                        >
                            ...
                            <DialogContent className="nav">
                                ...
                                <Box sx={{display:"flex",flexWrap:"wrap",alignItems:"center",padding:"0px 30px"}}>
                                    ...
                                    <span>+91</span>
                                    <Input type="number" name="number" onChange={(e)=>signinInput(e)} inputProps={ariaLabel} sx={{width:"80%",fontSize:"14px"}}/>
                                </Box>
                            </DialogContent>
                    ...
                    <Container>
                        <Box sx={{display:"flex",flexWrap:"wrap",justifyContent:"space-between"}}>
                            <Box px={3} sx={{display:{ xs: 'flex',lg:'flex', md: 'flex',sm:'none',xs:'none' },flexWrap:"wrap"}} columnGap={"25px"}>
                                <List>
                                    <a href="#" style={{fontSize:"16px",textDecoration:"none",color:"white"}}>Movies</a>
                                </List>
                                <List>
                                    <a href="#" style={{fontSize:"16px",textDecoration:"none",color:"white"}}>Stream</a>
                                </List>
                                <List>
                                    <a href="#" style={{fontSize:"16px",textDecoration:"none",color:"white"}}>Events</a>
                                </List>
                                <List>
                                    <a href="#" style={{fontSize:"16px",textDecoration:"none",color:"white"}}>Play</a>
                                </List>
                                <List>
                                    <a href="#" style={{fontSize:"16px",textDecoration:"none",color:"white"}}>Sports</a>
                                </List>
                                <List>
                                    <a href="#" style={{fontSize:"16px",textDecoration:"none",color:"white"}}>Activities</a>
                                </List>
                                <List>
                                    <a href="#" style={{fontSize:"16px",textDecoration:"none",color:"white"}}>Buzz</a>
                                </List>
                            </Box>

                            <Box px={3} sx={{display:{ xs: 'flex',lg:'flex', md: 'flex',sm:'none',xs:'none' },flexWrap:"wrap"}} columnGap={"25px"}>
                                <List>
                                    <a href="#" style={{fontSize:"16px",textDecoration:"none",color:"white"}}>ListYourShow</a>
                                </List>
                                <List>
                                    <a href="#" style={{fontSize:"16px",textDecoration:"none",color:"white"}}>Corporate</a>
                                </List>
                                <List>
                                    <a href="#" style={{fontSize:"16px",textDecoration:"none",color:"white"}}>Offers</a>
                                </List>
                                <List>
                                    <a href="#" style={{fontSize:"16px",textDecoration:"none",color:"white"}}>Gift Cards</a>
                                </List> 
                            </Box>
                        </Box>
                    </Container>
